...
class SpeculativeConfig:
    ...
    def use_step3p5_mtp(self) -> bool:
        # Step3.5's proposer selects MTP layer i for draft step i. Multi-layer
        # MiMo-V2 MTP (n_predict > 1) uses the same per-step path.
        ...
        if model_type == "mimo_v2_mtp":
            return (getattr(hf, "n_predict", None) or 1) > 1
        return model_type == "step3p5_mtp"
